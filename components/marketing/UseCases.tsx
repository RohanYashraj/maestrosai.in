  ...
  return (
    <section className="py-24 md:py-32 bg-background">
      <Container>
        ...
        <div className="grid md:grid-cols-2 gap-px bg-ink/5 border border-border/70 rounded-lg overflow-hidden">
          {items.map((item, index) => (
            <div
              key={index}
              className="bg-surface/95 p-10 md:p-12 transition-colors hover:bg-muted/40"
            >
